...
function EditPanel({
  ...
  panel: Panel;
  panelFormRef: MutableRefObject<HTMLFormElement | null>;
  onSubmit: (formData: CreatePanelFormData) => void;
}) {
  ...
  const methods = useForm<CreatePanelFormData>({
    ...
    defaultValues: {
      ...
      depth: panel.depth || 0,
      width: panel.width || 0,
      pouringDays: panel.pouringDays || 2,
      phase: panel.phase || "",
      material: panel.material || "",
      tonnage: panel.tonnage || 0,
      finishingTime: panel.finishingTime || null,
      projectId: panel.projectId || null,
      startDate: panel.startDate || null,
      dueDate: panel.dueDate || null,
    },
  });
  ...
  return (
    <FormProvider {...methods}>
      <Container maxWidth="xs">
        <form
          onSubmit={onSubmit}
          autoComplete="edit-panel"
          name="edit-panel"
          ref={(ref) => {
            if (ref) panelFormRef.current = ref;
          }}
        >
